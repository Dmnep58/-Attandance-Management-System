                    ...
                    <body>
                        <section class="container1">
                            <div class="heading">
                                ...
                                <div> <button class="button" id="openPopupButton">+ Add Student</button>
...
List<TeacherStudent> l = t.FetchStudentData();
%>
                                <div id="data-table">
                                    <table>
                                        <tr>
                           ...
                           for(TeacherStudent s : l){
                        	 ...
                        	 %>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="table-button1">Edit</button>
                                                        <button class="table-button2" onclick="deleteRecord('<%=s.getUid()%>')">Delete</button>
                                                    </td>
                                                </tr>
